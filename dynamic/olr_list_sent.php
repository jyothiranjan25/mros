...
$personal_mail="";
   ...
   while ($row=mysqli_fetch_array($name))
   {
    ...
    $page_accept="https://mros.ifim.edu.in/dynamic/cand_offerletter_accept.php?name=".$cand_name;
    $page_reject="https://mros.ifim.edu.in/dynamic/cand_offerletter_reject.php?name=".$cand_name;
