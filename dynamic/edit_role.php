...
{ 
    ...
    if(!$edit_authority1){$edit_authority1=0;}
    //echo "<script>alert('".$edit_authority1."');</script>";

    $edit_authority2=$_POST['authority2'];
    if(!$edit_authority2){$edit_authority2=0;}


    $edit_authority3=$_POST['authority3'];
    if(!$edit_authority3){$edit_authority3=0;}


    $edit_authority4=$_POST['authority4'];
    if(!$edit_authority4){$edit_authority4=0;}


    $edit_authority5=$_POST['authority5'];
    if(!$edit_authority5){$edit_authority5=0;}


    $edit_authority6=$_POST['authority6'];
    if(!$edit_authority6){$edit_authority6=0;}


    $edit_authority7=$_POST['authority7'];
    if(!$edit_authority7){$edit_authority7=0;}


    $edit_authority8=$_POST['authority8'];
    if(!$edit_authority8){$edit_authority8=0;}


    $edit_authority9=$_POST['authority9'];
    if(!$edit_authority9){$edit_authority9=0;}


    $edit_authority10=$_POST['authority10'];
    if(!$edit_authority10){$edit_authority10=0;}
