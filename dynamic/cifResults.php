...
{
  $cand_name=$row['cand_name'];$entity=$row['entity_name'];$type=$row['jobtype'];$months=$row['jobmonths'];$pos_new=$row['pos'];$job_new_title=$row['job_title'];$j_date=$row['joining_date'];$ctc=$row['ctc'];$st=10;$emp_em_id="";$email_emp="";
}
 ...
 $new_emp_table=$entity." new_emp";$role_new_emp="New Employee";
...
?> 
  <!-- <a href="cifResults.php?id=<?php //echo htmlentities($row['olr_id']);?>" onclick="return confirm('Do you want to Delete the CIF...')" class="btn btn-danger" ><i class="fa fa-bin" aria-hidden="true"></i> Reject </a> -->
