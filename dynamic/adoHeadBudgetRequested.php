          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                       <h2>Details of the  Budget Requested</h2>
...
$offerletter_query=mysqli_query($con,"SELECT * FROM budgetrequests WHERE requested_by='$mail'");
$cnt=1;
...
<?php if($row['status']==0)
{
  ?><td><a class="btn btn-primary" style="color: white" >Requested</a>
</td>
<?php } elseif($row['status']==1) {?>

<td><a class="btn btn-success" style="color: white">Approved</a>
</td>
<?php } elseif($row['status']==2) {?>

<td><a class="btn btn-danger" style="color: white">Rejected</a>
</td>
