...
$new_data="1";
$inset_query=mysqli_query($con, "INSERT INTO `$table` (name, email, emp_id, role,dep)
  VALUES ('$name', '$mail', '$emp_id', '$role', '$dep')");
      if($inset_query)
      {
    ...
    function  selectempid(str){
     ...
     req.onreadystatechange=function(){
       if(req.readyState==4&&req.status==200){
         document.getElementById("emp_id").innerHTML=req.responseText;
       }
     }
    } 
    </script>
			...
			<div class="right_col" role="main">
				<div class="">
                    ...
                    <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
                      <select name="emp_id" id="emp_id" title="" class="form-control" required="" onchange="selectempname(this.value);" >
                                             <option value="0">First Select employee mail id</option> 
                                      </select>
                    ...
                    <div class="item form-group">
                        ...
                        <input name="username" <?php echo $value; ?> type="text" id="user_name" required="required" class="form-control " >
