                ...
                <div class="col-sm-12">
                  <div class="card-box table-responsive">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php
                        $feedback = mysqli_query($con, "SELECT * FROM `employee_details`");
                        ...
                        ?>
                          <tr>
                            ...
                            <?php } else if ($row['status'] == 1 || $row['status'] == 2) {  ?>
                              <td>
                                <a href="#" type="button" class="btn btn-success">Requested</a>
                              </td>

                            <?php } elseif ($row['status'] == 10 || $row['status'] == 11) { ?>
                              <td>
                                <a href="#" type="button" class="btn btn-primary">New Employee(All requirments not completed)</a>
                              </td>
                            <?php } else {
                            ?>
                              <td>
                                <a href="#" type="button" class="btn btn-primary">Confirmed</a>
                              </td>
                            <?php
                            } ?>
                          </tr>
