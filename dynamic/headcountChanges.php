...
$offerletter_query=mysqli_query($con,"SELECT * FROM hc_changes order by hc_changes.date desc ");
$cnt=1;
...
<tr>
    ...
    <td><?php echo htmlentities($cnt);?></td>
                                                            <td><?php echo htmlentities($row['entity']);?></td>
                                                              <td><b><?php echo htmlentities($row['position']);?></b></td>
                                                            <td><?php echo htmlentities($row['month']);?></td>
                                                             <td><b><?php echo htmlentities($row['hc']);?></b></td>
