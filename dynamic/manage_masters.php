...
session_start(); 
$page=$_GET['page'];
      $table=strtolower(str_replace(" ","_",$page)."_Emp");
...
if(isset($_REQUEST['del']))
  {
      ...
      $role=$_REQUEST['role'];
      $table=strtolower(str_replace(" ","_",$entity)."_Emp");
                      ...
                      <tbody>
                          ...
                          ?>
                            <tr>
                                    ...
                                    <a href="manage_masters.php?del=<?php echo htmlentities($row['emp_id']);?>&entity=<?php echo htmlentities($page);?>&role=<?php echo htmlentities($row['role']);?>" class="btn btn-danger" ><i class="fa fa-trash" aria-hidden="true"></i>
</a></td>          
                            </tr>
                            <?php
                            $cnt++;
