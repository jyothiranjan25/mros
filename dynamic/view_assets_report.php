...
?></td>
  ...
  <td><a href="assets_report.php?emp_id=<?php echo htmlentities($row['emp_id']);?>&joining_date=<?php echo htmlentities($row['joining_date']);?>" class="btn btn-success" > View </a></td>
