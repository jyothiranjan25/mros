...
$olr_id=$_GET['id'];$info_to_cand=$_GET['information'];
...
$row=mysqli_fetch_array($name);
  ...
  $page_accept="https://mros.ifim.edu.in/dynamic/CIF_deatail.php?id=".$olr_id;
...
?>
          ...
          <br />
                ...
                <div class="x_content">
                  <center><h3><b>CIF Resend to candidate</b></h3></center><br>
