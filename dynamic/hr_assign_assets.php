                      ...
                      <table class="table table-bordered" id="dynamic_field">
                        <tr>
		                  ...
		                  <?php
		                        ...
		                        $entity_query=mysqli_query($con,"SELECT `name` FROM `employee_details`");
