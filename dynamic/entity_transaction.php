...
$entity=$_GET['page'];
$table=strtolower(str_replace(" ","_",$entity)."_transaction");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
include('includes/topbar.php'); ?>
    ...
    <th> Budget Changed</th>
    <th> HeadCount Changed</th>
...
$offerletter_query=mysqli_query($con,"SELECT * FROM `$table` ORDER BY `date` DESC");
$cnt=1;
...
<tr>
    ...
    <td><?php echo htmlentities($cnt);?></td>
                                                              ...
                                                              <td><b><?php echo htmlentities(number_format($row['budget'],2));?>/annum</b></td>
